                                ...
                                <div class="dt-card dt-card__full-height text-dark">
                                    ...
                                    <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                        ...
                                        <div class="media">
                                            ...
                                            <i class="fa fa-dollar-sign fa-3x fa-fw mr-6 align-self-center"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-12 order-xl-1">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr id="row<?php echo $plan->id ?>">
                                                            ...
                                                            <td><?php $val = $plan->principalReturn == 1 ? lang('yes') : lang('no');
                                                                echo $val ?>
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <?php if ($this->user_model->getPermissions('plans', 'edit', $userId) or $role == ROLE_ADMIN) { ?>
                                                                    <a class="btn btn-sm btn-info" href="<?php echo base_url() . 'plans/edit/' . $plan->id; ?>" title="Edit"><?php echo lang('edit') ?></a>
                        ...
                        <div class="dt-card__body">
                            ...
                            <!-- Modal -->
                            <div class="modal fade display-n" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="model-8" aria-hidden="true">
