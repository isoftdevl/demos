...
<div class="dt-content-wrapper">
    ...
    <div class="dt-content">
            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    ...
                    <?php } else if ($pageTitle == 'Deposits') { ?>
                        <?php if ($role == ROLE_ADMIN || $this->user_model->getPermissions('deposits', 'add', $userId)) { ?>
                                ...
                                <div class="col-sm-4 col-12">
                                    ...
                                    <div class="dt-card dt-card__full-height text-dark">
                                        ...
                                        <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                            <span class="badge bg-secondary text-white badge-top-right"><?php echo lang('principal_repayments') ?></span>
                                            <!-- Media -->
                                            <div class="media">
                        ...
                        <div class="dt-card">
                            <?php if (!empty($userInfo->pmtAccount) or $role == ROLE_ADMIN or $role == ROLE_MANAGER) { ?>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr id="row<?php echo $transaction->id ?>">
                                                                ...
                                                                <td>
                                                                    <?php if ($pageTitle == 'Withdrawals') { ?>
                                                                        <?php echo to_currency($transaction->amount_less_transaction_fee) ?> <a style="color: green;" data-fees="<?php echo to_currency($transaction->transaction_fee) ?>" data-amount="<?php echo to_currency($transaction->amount) ?>" data-amountlessfee="<?php echo to_currency($transaction->amount_less_transaction_fee) ?>" id="pfm" data-toggle="modal" data-target="#pricemodal">[View Charges]</a>
                                                                    <?php } else { ?>
                                                                        <?php echo to_currency($transaction->amount) ?>
                                                                    <?php } ?>
                                                                </td>
                                                                <?php if ($pageTitle == 'Withdrawals') { ?>
                                                                    ...
                                                                    <?php if ($role == ROLE_CLIENT) { ?>
                                                                        <td class="collastcl" id="col<?php echo $transaction->txnCode ?>">
                                                                            <?php if (($transaction->maturityDtm < date('Y-m-d H:i:s')) && $transaction->status == 0) { ?>
                                                                                <!--
                                                        <button class="btn btn-sm btn-info reinvest trans-btn" id="reinvest<?php //echo $transaction->txnCode 
                                                                                                                            ?>" data-toggle="modal" value="<?php //echo $transaction->txnCode 
                                                                                                                                                            ?>" data-target="#modal"><?php //echo lang('reinvest') 
                                                                                                                                                                                        ?></button>
                                                        
                                                        <button data-toggle="modal" id="<?php //echo $transaction->txnCode 
                                                                                        ?>" data-target="#modal" value="<?php //echo to_currency($transaction->amount) 
                                                                                                                        ?>" class="btn btn-sm btn-info withdraw trans-btn"><?php //echo lang('withdraw') 
                                                                                                                                                                            ?></button>
                                                        -->
                                                                ...
                                                                <?php if ($pageTitle == 'Withdrawals') { ?>
                                                                    <td class="text-center p-0-5m">
                                                                        <?php if ($role == ROLE_CLIENT) { ?>
                                                                            <button class="btn btn-sm btn-info accountsButton trans-btn" data-userid="<?php echo $transaction->id ?>" data-url="<?php echo base_url('user_payment_accounts/') . $transaction->id ?>" title="Payment Accounts" data-toggle="modal" data-target="#accountsModal">Payment Details</button>
                                                                        <?php }
                                                                        if ($role == ROLE_ADMIN or $role == ROLE_MANAGER) { ?>
                                                                            <?php if ($transaction->status == 0) { ?>
                                                                                ...
                                                                                <?php if ($this->user_model->getPermissions('withdrawals', 'approve', $userId) or $role == ROLE_ADMIN) { ?>
                                                                                    <button class="btn btn-sm btn-info confirmAction trans-btn" data-userid="" title="accept" data-url="<?php echo base_url('user_payment_accounts/') . $transaction->id ?>" id="confirmButton<?php echo $transaction->id ?>" value="<?php echo base_url('approveWithdrawal/') . $transaction->id ?>" data-toggle="modal" data-target="#confirmationModal"><?php echo lang('approve') ?></button>
                                                                                    <button class="btn btn-sm btn-info declineAction trans-btn" data-userid="" title="accept" id="declineButton<?php echo $transaction->id ?>" value="<?php echo base_url('declineWithdrawal/') . $transaction->id ?>" data-toggle="modal" data-target="#declineModal">Decline</button>
                                                                                <?php } else { ?>
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <!-- /modal -->
                                    <div class="modal fade display-n" id="pricemodal" tabindex="-1" role="dialog" aria-labelledby="model-8" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                    ...
                                    <?php if ($role == ROLE_ADMIN || $role == ROLE_MANAGER) { ?>
                                        <!-- Modal -->
                                        <div class="modal fade display-n" id="declineModal" tabindex="-1" role="dialog" aria-labelledby="model-8" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" name="password" id="passwordDec" type="password">
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary btn-sm" id="buttonSubmitDec"><?php echo lang('save') ?>
                                                        </button>
                                                    </div>
                                                    <!-- /modal footer -->
                                                    <?php echo form_close(); ?>
                                        ...
                                        <!-- /modal -->
                                        <!-- Modal -->
                                        <div class="modal fade display-n" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="model-8" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary btn-sm" id="buttonSubmit"><?php echo lang('save') ?>
                                                        </button>
                                                    </div>
                                                    <!-- /modal footer -->
                                                    <?php echo form_close(); ?>
        ...
        <!-- Modal -->
        <div class="modal fade display-n" id="modal" tabindex="-1" role="dialog" aria-labelledby="model-8" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <!-- Modal Content -->
                <div class="modal-content">
