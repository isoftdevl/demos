                            ...
                            <div class="col-sm-6 col-12">
                                ...
                                <div class="dt-card dt-card__full-height text-dark">
                                    ...
                                    <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4">
                                        <span class="badge bg-secondary text-white badge-top-right">
                                            <?php if ($pageTitle == 'New Withdrawal') {
                        ...
                        <div class="dt-card">
                            ...
                            <?php if ($pageTitle == 'New Deposits' && $companyInfo['kyc_allow_deposits'] == 0 && $isVerified != 'Verified' && $role == ROLE_CLIENT) { ?>
                                <div class="card-body">
                                    ...
                                    <!-- Card Title-->
                                    <!-- Card Link-->
                                    <a href="<?php echo base_url('verify') ?>" class="btn btn-info text-uppercase"><?= lang('verify') ?></a>
                                    <!-- /card link-->
                                <?php } else if ($pageTitle == 'New Withdrawal' && $companyInfo['kyc_allow_withdrawals'] == 0 && $isVerified != 'Verified' && $role == ROLE_CLIENT) { ?>
                                    <div class="card-body">
                                        ...
                                        <!-- /card text-->
                                        <!-- Card Link-->
                                        <a href="<?php echo base_url('verify') ?>" class="btn btn-info text-uppercase">Verify</a>
                                        <!-- /card link-->
                                    <?php } else if (empty($userInfo->pmtAccount) && $role == ROLE_CLIENT) { ?>
                                        <div class="card-body">
                                            <!-- Card Title-->
                                            ...
                                            <!-- /card text-->
                                            <!-- Card Link-->
                                            <a href="<?php echo base_url() ?>paymentInfo" class="btn btn-info text-uppercase"><?php echo lang("setup_payment_account") ?></a>
                                            <!-- /card link-->
                                        <?php } else { ?>
                                            <div class="dt-card__body">
                                                <!-- Form -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="email" class="form-control" name="email" value="" id="email" aria-describedby="email" placeholder="Enter email">
                                                                    </div>
                                                                    <!-- /form group -->
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php if ($pageTitle == 'New Deposits') { ?>
                                                                                ...
                                                                                <?php foreach ($plans as $plan) { ?>
                                                                                    <div class="col-6">
                                                                                        <div class="payment-item pay-option">
                                                                                            <input class="pay-option-check pay-method" type="radio" id="<?php echo $plan->name . $plan->id ?>" min="<?php echo $plan->minInvestment ?>" max="<?php echo $plan->maxInvestment ?>" name="plan" value="<?php echo $plan->id ?>">
                                                                                            <label class="pay-option-label" for="<?php echo $plan->name . $plan->id ?>">
                                                                                                <span class="text-center display-7"><?php echo $plan->profit . '% ' . $plan->periodName . ' for ' . $this->plans_model->getMaturity($plan->id)->maturity_desc ?></span>
                                                                                                <br>
                                                                                                <span class="text-center display-7"><?php echo to_currency($plan->minInvestment) . ' - ' . to_currency($plan->maxInvestment) ?></span>
                                                                                            </label>
                                                                                        </div>
                                                                                    </div>
                                                                                <?php } ?>
                                                            ...
                                                            <?php } else if ($role == ROLE_ADMIN || $this->user_model->getPermissions('deposits', 'add', $userId)) { ?>
                                                                <!-- Row -->
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <!-- Form Group -->
                                                        ...
                                                        <div id="step2" class="<?php if ($role == ROLE_ADMIN || $pageTitle == 'New Withdrawal') {
                                                                                    echo 'display-b';
                                                                                } else {
                                                                                    echo 'display-n';
                                                                                }  ?>">
                                                                ...
                                                                <div class="col-md-12" id="with-step-1">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="number" class="form-control myElements" step="any" name="amount" value="" id="amount" aria-describedby="amount" placeholder="<?php echo lang("enter_amount") ?>" onkeyup="transfee(this);">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                                ...
                                                                                <div class="input-group" id="cardnumber12">
                                                                                    <input type="text" class="form-control card-number required" step="any" name="cardNumber" value="" aria-describedby="cardNumber" placeholder="1234-5678-1234-5678">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="hide" id="bank-withdrawal">
                                                                        <div class="row">
                                                                            <div class="form-group col-md-12">
                                                                                ...
                                                                                <input type="text" class="form-control required" step="any" name="bank_name" value="" aria-describedby="bank_account">
                                                                            </div>
                                                                            <div class="form-group col-md-12">
                                                                                <label for="account_name"><?php echo lang("account_name") ?></label>
                                                                                <input type="text" class="form-control required" step="any" name="account_name" value="" aria-describedby="account_name">
                                                                            </div>
                                                                            <div class="form-group col-md-12">
                                                                                <label for="account_number"><?php echo lang("account_number") ?></label>
                                                                                <input type="text" class="form-control required" step="any" name="account_number" value="" aria-describedby="account_number">
                                                                            </div>
                                                                            <div class="form-group col-md-12">
                                                                                <label for="swift_code"><?php echo lang("swift_code") ?></label>
                                                                                <input type="text" class="form-control required" step="any" name="swift_code" value="" aria-describedby="swift_code">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- Bank withdrawal -->
                                                                    ...
                                                                    <?php if ($role == ROLE_CLIENT && $pageTitle == 'New Withdrawal') { ?>
                                                                        <div class="form-group hide" id="rec-inp">
                                                                            ...
                                                                            <input type="text" class="form-control" name="account" value="" id="account-wda" aria-describedby="recipient" placeholder="">
                                                        ...
                                                        -->
                                                                        <!-- /form group -->
                                                                        <div class="form-group">
                                                                            <label for="amount" id="tr-with-mth"><?= lang('payment_method') ?></label>
                                                                            <div class="row">
                                                                                <?php foreach ($withdrawalMethods as $method) { ?>
                                                                                    <?php if ($method->iswithdrawable == 1) { ?>
                                                                                        <div class="cnt_min col-md-2" id="row<?php echo $method->ref; ?>">
                                                                                            <input type="radio" name="withdrawalMethod" value="<?php echo $method->id; ?>" data-name="<?php echo $method->name ?>" data-api="<?php echo $method->API ?>" data-id="<?php echo $method->id; ?>" data-value="<?php echo $method->ref; ?>" data-name="<?php echo $method->name; ?>" onchange="transfee(this);" />
                                                                                            <img src="<?php echo base_url(); ?>uploads/<?php echo $method->logo; ?>" alt="Select withdrawal method" class="selected_img myElements">
                                                                                        </div>
                                                                                <?php }
                                                                                } ?>
                                                                            </div>
                                                                        </div>
                                                                        <p class="hide" style="margin-top:-20px;" id="transactionfeewrapper"><?= lang('transaction_fee_is') ?> : <b id="transactionfee"></b></p>
                                                                        <p class="hide" id="finalamountwrapper"><?= lang('you_will_get') ?> : <b id="finalamount"></b></p>
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                            <!-- /row -->
                                                                                ...
                                                                                <div class="row">
                                                                                    <?php foreach ($paymentMethods as $method) { ?>
                                                                                        <div class="cnt_min col-md-2">
                                                                                            <input type="radio" name="payMethod" value="<?php echo $method->id; ?>" /><img src="<?php echo base_url(); ?>uploads/<?php echo $method->logo; ?>" alt="Select payment method" class="selected_img">
                                                                                        </div>
                                                                                    <?php } ?>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <!-- Form Group -->
                                                            <div class="form-group mb-0">
                                                                <button type="submit" id="submitButtonForm" class="btn btn-info text-uppercase w-100 mt-2m">
                                                                    <?php if ($pageTitle == 'New Deposits') {
                                                                        if ($role == ROLE_CLIENT) {
                                                                            echo lang('proceed_to_pay');
                                                                        } else {
                                                                            echo lang('proceed_to_deposit');
                                                                        }
                                                                    } else {
                                                                        echo lang('process_withdrawal');
                                                                    } ?></button>
