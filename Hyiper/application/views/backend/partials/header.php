            ...
            <?php } else { ?>
                                ...
                                <?php } else { ?>
                                    <form method="post">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" placeholder="Search <?php echo $pageTitle; ?>" name="searchText" value="<?php echo html_purify(set_value('searchText')); ?>" type="search">
                                ...
                                <ul class="dt-nav">
                                    <li class="dt-nav__item dropdown">
                                        ...
                                        <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <img class="dt-avatar size-30" src="<?php echo $ppic; ?>" alt="<?php echo $firstName . ' ' . $lastName; ?>">
                                            <span class="dt-avatar-info d-none d-sm-block">
                                                <span class="dt-avatar-name"><?php echo $firstName . ' ' . $lastName; ?></span>
                                                <?php if ($role == 3) { ?>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>profile"> <i class="icon icon-user icon-fw mr-2 mr-sm-1"></i><?php echo lang("account") ?>
                                            </a>
                                            <a class="dropdown-item" href="<?php echo base_url(); ?>logout"> <i class="icon icon-editors icon-fw mr-2 mr-sm-1"></i><?php echo lang("logout") ?>
                                            </a>
                                        </div>
                                        <!-- /dropdown option -->
                ...
                <main class="dt-main">
                    ...
                    <aside id="main-sidebar" class="dt-sidebar ps ps--active-y">
                                ...
                                <div _ngcontent-ovt-c266="" perfectscrollbar="" class="dt-module__sidebar-content position-relative ng-tns-c266-22 ng-trigger ng-trigger-collapseAppSidebar ps ps--active-y" style="display: block; opacity: 1;">
                                    <div _ngcontent-ovt-c266="" class="dt-module__sidebar-content-inner pt-md-7 ng-tns-c266-22">
                                        <ul _ngcontent-ovt-c266="" class="dt-module-side-nav ng-tns-c266-22">
                                            ...
                                            <li class="dt-module-side-nav__item ng-tns-c266-22 <?php if ($this->uri->segment(1) == "tickets" && $this->uri->segment(2) == "") {
                                                                                                    echo "active";
                                                                                                } ?>">
                                            ...
                                            <li class="dt-module-side-nav__item ng-tns-c266-22 <?php if ($this->uri->segment(1) == "tickets" && $this->uri->segment(2) == "open") {
                                                                                                    echo "active";
                                                                                                } ?>">
                                            ...
                                            <li class="dt-module-side-nav__item ng-tns-c266-22 <?php if ($this->uri->segment(1) == "tickets" && $this->uri->segment(2) == "resolved") {
                                                                                                    echo "active";
                                                                                                } ?>">
                                ...
                                <div class="dt-module__sidebar-content position-relative ng-tns-c266-22 ng-trigger ng-trigger-collapseAppSidebar ps ps--active-y" style="display: block; opacity: 1;">
                                    <div class="dt-module__sidebar-content-inner pt-md-7 ng-tns-c266-22">
                                        <ul class="dt-module-side-nav ng-tns-c266-22">
                                            <li class="dt-module-side-nav__item ng-tns-c266-22 <?php if ($this->uri->segment(1) == "webcontrol" && $this->uri->segment(2) == "templates") {
                                                                                                    echo "active";
                                                                                                } ?>">
                                            ...
                                            <li class="dt-module-side-nav__item ng-tns-c266-22 <?php if ($this->uri->segment(1) == "webcontrol" && $this->uri->segment(2) == "terms") {
                                                                                                    echo "active";
                                                                                                } ?>">
                                            ...
                                            <li class="dt-module-side-nav__item ng-tns-c266-22 <?php if ($this->uri->segment(1) == "webcontrol" && $this->uri->segment(2) == "policy") {
                                                                                                    echo "active";
                                                                                                } ?>">
                                            ...
                                            <li class="dt-module-side-nav__item ng-tns-c266-22 <?php if ($this->uri->segment(1) == "webcontrol" && $this->uri->segment(2) == "faqs") {
                                                                                                    echo "active";
                                                                                                } ?>">
                        ...
                        <?php } else if ($this->uri->segment(1) == "kyc-portal") { ?>
                            <?php if ($role != ROLE_CLIENT) { ?>
                                <app-task-sidebar class="ng-tns-c266-22 dt-module__sidebar active" style="max-width: none;border-right: none;">
                                    <div class="dt-module__sidebar-header ng-tns-c266-22">
                                        <div class="quick-menu-list ng-tns-c266-22">
                                    ...
                                    <div _ngcontent-ovt-c266="" perfectscrollbar="" class="dt-module__sidebar-content position-relative ng-tns-c266-22 ng-trigger ng-trigger-collapseAppSidebar ps ps--active-y" style="display: block; opacity: 1;">
                                        <div _ngcontent-ovt-c266="" class="dt-module__sidebar-content-inner pt-md-7 ng-tns-c266-22">
                                            <ul _ngcontent-ovt-c266="" class="dt-module-side-nav ng-tns-c266-22">
                                                <li _ngcontent-ovt-c266="" class="dt-module-side-nav__header ng-tns-c266-22">
                                                    <span _ngcontent-ovt-c266="" class="dt-module-side-nav__text ng-tns-c266-22"><?= lang('all_applications') ?></span>
                                                    <?php if (isset($_SESSION['helpdesk_priority']) || isset($_SESSION['helpdesk_team'])) { ?>
                                                        <span _ngcontent-ovt-c266="" class="dt-module-side-nav__text ng-tns-c266-22" style="float: right;">
                                                            <a href="#" id="ticketFilterOff">
                                                                <span class="dt-module-side-nav__text ng-tns-c266-22"><?php echo lang('remove_filters') ?></span>
                                                ...
                                                <li class="dt-module-side-nav__item ng-tns-c266-22">
                                                    <a class="dt-module-side-nav__link ng-tns-c266-22" href="<?php echo base_url('kyc-all-applications') ?>" style="width: 100%;">
                                                        <i name="dashboard" size="lg" class="ng-tns-c266-22 icon icon-forms-basic icon-lg icon-fw"></i>
                                                        <span class="dt-module-side-nav__text ng-tns-c266-22"><?= lang('all_applications') ?></span>
                                                    </a>
                                                </li>
                                                <li class="dt-module-side-nav__header ng-tns-c266-22">
                                                    <span class="dt-module-side-nav__text ng-tns-c266-22"><?php echo lang('status') ?></span>
                                                ...
                                                <li class="dt-module-side-nav__item ng-tns-c266-22 ng-star-inserted" style="">
                                                    <a class="dt-module-side-nav__link ng-tns-c266-22" href="javascript:void(0);">
                                                        <gx-checkbox class="dt-checkbox dt-checkbox-icon dt-checkbox-only">
                                                            <input type="checkbox" name="newsubmission" id="gx-checkbox-230" class="checkbox-check ng-pristine ng-valid ng-touched" <?php echo isset($_SESSION['newsubmission']) && $_SESSION['newsubmission'] == 'true' ? 'checked' : '' ?>>
                                                            <label class="font-weight-light dt-checkbox-content" for="gx-checkbox-230">
                                                                <span class="unchecked">
                                                                    <i name="box-o" size="xl" class="icon icon-box-o icon-xl icon-fw"></i>
                                                                </span>
                                                                <span class="checked ng-star-inserted">
                                                        ...
                                                        <span class="dt-module-side-nav__text ng-tns-c266-22"><?= lang('new_submissions') ?></span>
                                                    </a>
                                                </li>
                                                <li class="dt-module-side-nav__item ng-tns-c266-22 ng-star-inserted" style="">
                                                    <a class="dt-module-side-nav__link ng-tns-c266-22" href="javascript:void(0);">
                                                        <gx-checkbox class="dt-checkbox dt-checkbox-icon dt-checkbox-only">
                                                            <input type="checkbox" name="resubmitted" id="gx-checkbox-231" class="checkbox-check ng-pristine ng-valid ng-touched" <?php echo isset($_SESSION['resubmitted']) && $_SESSION['resubmitted'] == 'true' ? 'checked' : '' ?>>
                                                            <label class="font-weight-light dt-checkbox-content" for="gx-checkbox-231">
                                                                <span class="unchecked">
                                                                    <i name="box-o" size="xl" class="icon icon-box-o icon-xl icon-fw"></i>
                                                                </span>
                                                                <span class="checked ng-star-inserted">
                                                        ...
                                                        <span class="dt-module-side-nav__text ng-tns-c266-22"><?= lang('resubmitted') ?></span>
                                                    </a>
                                                </li>
                                                <!---->
                                                <li class="dt-module-side-nav__item ng-tns-c266-22 ng-star-inserted" style="">
                                                    <a class="dt-module-side-nav__link ng-tns-c266-22" href="javascript:void(0);">
                                                        <gx-checkbox class="dt-checkbox dt-checkbox-icon dt-checkbox-only">
                                                            <input type="checkbox" name="pendingresubmission" id="gx-checkbox-232" class="checkbox-check ng-pristine ng-valid ng-touched" <?php echo isset($_SESSION['pendingresubmission']) && $_SESSION['pendingresubmission'] == 'true' ? 'checked' : '' ?>>
                                                            <label class="font-weight-light dt-checkbox-content" for="gx-checkbox-232">
                                                                <span class="unchecked">
                                                                    <i name="box-o" size="xl" class="icon icon-box-o icon-xl icon-fw"></i>
                                                                </span>
                                                                <span class="checked ng-star-inserted">
                                                        ...
                                                        <span class="dt-module-side-nav__text ng-tns-c266-22"><?= lang('pending_resubmission') ?></span>
                                                    </a>
                                                </li>
                                                <!---->
                                                ...
                                                <li class="dt-module-side-nav__item ng-tns-c266-22 ng-star-inserted" style="">
                                                    <a class="dt-module-side-nav__link ng-tns-c266-22" href="javascript:void(0);">
                                                        <gx-checkbox class="dt-checkbox dt-checkbox-icon dt-checkbox-only">
                                                            <input type="checkbox" name="approved" id="gx-checkbox-233" class="checkbox-check ng-pristine ng-valid ng-touched" <?php echo isset($_SESSION['approved']) && $_SESSION['approved'] == 'true' ? 'checked' : '' ?>>
                                                            <label class="font-weight-light dt-checkbox-content" for="gx-checkbox-233">
                                                                <span class="unchecked">
                                                                    <i name="box-o" size="xl" class="icon icon-box-o icon-xl icon-fw"></i>
                                                                </span>
                                                                <span class="checked ng-star-inserted">
                                                        ...
                                                        <span class="dt-module-side-nav__text ng-tns-c266-22"><?= lang('approved') ?></span>
                                                    </a>
                                                </li>
                                                <!---->
                                                <li class="dt-module-side-nav__item ng-tns-c266-22 ng-star-inserted" style="">
                                                    <a class="dt-module-side-nav__link ng-tns-c266-22" href="javascript:void(0);">
                                                        <gx-checkbox class="dt-checkbox dt-checkbox-icon dt-checkbox-only">
                                                            <input type="checkbox" name="rejected" id="gx-checkbox-234" class="checkbox-check ng-pristine ng-valid ng-touched" <?php echo isset($_SESSION['rejected']) && $_SESSION['rejected'] == 'true' ? 'checked' : '' ?>>
                                                            <label class="font-weight-light dt-checkbox-content" for="gx-checkbox-234">
                                                                <span class="unchecked">
                                                                    <i name="box-o" size="xl" class="icon icon-box-o icon-xl icon-fw"></i>
                                                                </span>
                                                                <span class="checked ng-star-inserted">
                                                        ...
                                                        <span class="dt-module-side-nav__text ng-tns-c266-22"><?= lang('rejected') ?></span>
                                                    </a>
                                                </li>
                                                <!---->
                                            </ul>
                        ...
                        <?php } else { ?>
                            <div class="dt-sidebar__container mt-10">
                                ...
                                <ul class="dt-side-nav">
                                    <?php if ($role == ROLE_CLIENT) { ?>
                                        <li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "dashboard") {
                                                                            echo "selected";
                                                                        } ?>">
                                            <a href="<?php echo base_url(); ?>dashboard" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "dashboard") {
                                                                                                                        echo "dt-active";
                                                                                                                    } ?>" title="Dashboard">
                                        ...
                                        <li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "deposits") {
                                                                            echo "open selected";
                                                                        } ?>">
                                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
                                                <i class="fa fa-dollar-sign fa-lg"></i> <span class="dt-side-nav__text"><?php echo lang("deposits") ?></span> </a>

                                            <!-- Sub-menu -->
                                            <ul class="dt-side-nav__sub-menu <?php echo $this->uri->segment(1) == "deposits" ? "display-b" : "display-n" ?>">
                                                <li class="dt-side-nav__item open <?php if ($this->uri->segment(1) == "deposits" && $this->uri->segment(2) == "new") {
                                                                                        echo "selected";
                                                                                    } ?>">
                                                    <a href="<?php echo base_url(); ?>deposits/new" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "deposits" && $this->uri->segment(2) == "new") {
                                                                                                                                    echo "active";
                                                                                                                                } ?>" title="Traffic">
                                                ...
                                                <li class="dt-side-nav__item">
                                                    <a href="<?php echo base_url(); ?>deposits" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "deposits" && $this->uri->segment(2) == "") {
                                                                                                                                echo "active";
                                                                                                                            } ?>" title="Revenue">
                                        ...
                                        <li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "withdrawals") {
                                                                            echo "selected open";
                                                                        } ?>">
                                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
                                                <i class="fa fa-wallet fa-lg"></i><span class="dt-side-nav__text"><?php echo lang("withdrawals") ?></span> </a>

                                            <!-- Sub-menu -->
                                            <ul class="dt-side-nav__sub-menu <?php echo $this->uri->segment(1) == "withdrawals" ? "display-b" : "display-n" ?>">
                                                <li class="dt-side-nav__item open <?php if ($this->uri->segment(1) == "withdrawals") {
                                                                                        echo "selected";
                                                                                    } ?>">
                                                    <a href="<?php echo base_url(); ?>withdrawals/new" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "withdrawals" && $this->uri->segment(2) == "new") {
                                                                                                                                    echo "active";
                                                                                                                                } ?>" title="Traffic">
                                                ...
                                                <li class="dt-side-nav__item">
                                                    <a href="<?php echo base_url(); ?>withdrawals" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "withdrawals" && $this->uri->segment(2) == "") {
                                                                                                                                echo "active";
                                                                                                                            } ?>" title="Revenue">
                                        ...
                                        <li class="dt-side-nav__item <?= $this->uri->segment(1) == "earnings" ? "selected" : '' ?>">
                                            <a href="<?= base_url('earnings'); ?>" class="dt-side-nav__link <?= $this->uri->segment(1) == "earnings" ? "dt-active" : ''; ?>" title="Earnings">
                                                <i class="fa fa-gift fa-lg"></i>
                                                <span class="dt-side-nav__text"><?php echo lang("earnings") ?></span>
                                            </a>
                                        </li>
                                        <li class="dt-side-nav__item <?= $this->uri->segment(1) == "referrals" ? "selected" : '' ?>">
                                            <a href="<?= base_url('referrals'); ?>" class="dt-side-nav__link <?= $this->uri->segment(1) == "referrals" ? "dt-active" : '' ?>" title="My Referrals">
                                                <i class="fa fa-users fa-lg"></i>
                                                <span class="dt-side-nav__text">My Referrals</span>
                                            </a>
                                        </li>
                                        <li class="dt-side-nav__item <?= $this->uri->segment(1) == "tickets" ? "selected" : '' ?>">
                                            <a href="<?= base_url('tickets'); ?>" class="dt-side-nav__link" title="Support">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <?php if (
                                            $this->user_model->getPermissions('teams', 'view', $userId) or
                                            $this->user_model->getPermissions('clients', 'view', $userId) or
                                            $role == ROLE_ADMIN
                                        ) { ?>
                                            <li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "clients" || $this->uri->segment(1) == "team") {
                                                                                echo "selected open";
                                                                            } ?>">
                                                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
                                                    <i class="fa fa-users fa-lg"></i><span class="dt-side-nav__text"><?php echo lang("users") ?></span> </a>
                                                ...
                                                <ul class="dt-side-nav__sub-menu <?php echo $this->uri->segment(1) == "clients" || $this->uri->segment(1) == "team" ? "display-b" : "display-n" ?>">
                                                    <?php if ($this->user_model->getPermissions('clients', 'view', $userId) or $role == ROLE_ADMIN) { ?>
                                                        <li class="dt-side-nav__item open <?php if ($this->uri->segment(1) == "clients") {
                                                                                                echo "selected";
                                                                                            } ?>">
                                                            <a href="<?php echo base_url(); ?>clients" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "clients") {
                                                                                                                                    echo "active";
                                                                                                                                } ?>" title="Traffic">
                                                    ...
                                                    <?php if ($this->user_model->getPermissions('teams', 'view', $userId) or $role == ROLE_ADMIN) { ?>
                                                        <li class="dt-side-nav__item">
                                                            <a href="<?php echo base_url(); ?>team" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "team") {
                                                                                                                                    echo "active";
                                                                                                                                } ?>" title="Revenue">
                                        ...
                                        <?php if (
                                            $this->user_model->getPermissions('deposits', 'view', $userId) or
                                            $this->user_model->getPermissions('withdrawals', 'view', $userId) or
                                            $this->user_model->getPermissions('payouts', 'view', $userId) or
                                            $role == ROLE_ADMIN
                                        ) { ?>
                                            <li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "withdrawals" || $this->uri->segment(1) == "deposits" || $this->uri->segment(1) == "earnings") {
                                                                                echo "selected open";
                                                                            } ?>">
                                                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
                                                    <i class="fa fa-dollar-sign fa-lg"></i><span class="dt-side-nav__text"><?php echo lang("transactions") ?></span> </a>
                                                ...
                                                <ul class="dt-side-nav__sub-menu <?php echo $this->uri->segment(1) == "withdrawals" || $this->uri->segment(1) == "deposits" || $this->uri->segment(1) == "earnings" ? "display-b" : "display-n" ?>">
                                                    <?php if ($this->user_model->getPermissions('deposits', 'view', $userId) or $role == ROLE_ADMIN) { ?>
                                                        <li class="dt-side-nav__item open <?php if ($this->uri->segment(1) == "deposits") {
                                                                                                echo "selected";
                                                                                            } ?>">
                                                            <a href="<?php echo base_url(); ?>deposits" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "deposits") {
                                                                                                                                        echo "active";
                                                                                                                                    } ?>" title="Traffic">
                                                    ...
                                                    <?php if ($this->user_model->getPermissions('withdrawals', 'view', $userId) or $role == ROLE_ADMIN) { ?>
                                                        <li class="dt-side-nav__item">
                                                            <a href="<?php echo base_url(); ?>withdrawals" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "withdrawals") {
                                                                                                                                        echo "active";
                                                                                                                                    } ?>" title="Revenue">
                                                    ...
                                                    <?php if ($this->user_model->getPermissions('payouts', 'view', $userId) or $role == ROLE_ADMIN) { ?>
                                                        <li class="dt-side-nav__item">
                                                            <a href="<?php echo base_url(); ?>earnings" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "earnings") {
                                                                                                                                        echo "active";
                                                                                                                                    } ?>" title="Revenue">
                                        ...
                                        <?php if ($this->user_model->getPermissions('plans', 'view', $userId) or $role == ROLE_ADMIN) { ?>
                                            <li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "plans") {
                                                                                echo "selected";
                                                                            } ?>">
                                                <a href="<?php echo base_url(); ?>plans" class="dt-side-nav__link" title="Contacts App">
                                                    <i class="fa fa-gift fa-lg"></i>
                                        ...
                                        <?php if ($this->user_model->getPermissions('settings', 'API_settings', $userId) or $role == ROLE_ADMIN) { ?>
                                            <li class="dt-side-nav__item">
                                                <a href="<?php echo base_url(); ?>settings/addons" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "settings" && $this->uri->segment(2) == "paymentsAPIs") {
                                                                                                                                echo "active";
                                                                                                                            } ?>" title="Plugins">
                                                    <i class="fa fa-play-circle fa-lg"></i>
                                                    <span class="dt-side-nav__text"><?php echo "Apps" ?></span> </a>
                                            </li>
                                        <?php } ?>
                                        <li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "tickets") {
                                                                            echo "selected";
                                                                        } ?>">
                                            <a href="<?php echo base_url(); ?>tickets" class="dt-side-nav__link" title="Support">
                                                <i class="fa fa-comment fa-lg <?= $ticketnotify == true ? 'dt-icon-alert' : '' ?>"></i>
                                                <span class="dt-side-nav__text"><?php echo lang('tickets') ?></span>
                                            </a>
                                        </li>
                                        <!--  <li class="dt-side-nav__item" <?php //if ($this->uri->segment(1) == "webcontrol") {
                                                                            //echo "selected";
                                                                            //} 
                                                                            ?>">
                                            <a href="<?php //echo base_url(); 
                                                        ?>webcontrol/templates" class="dt-side-nav__link <?php //if ($this->uri->segment(1) == "webcontrol") {
                                                                                                                                //echo "active";
                                                                                                                                // } 
                                                                                                                                ?>" title="Web Control">
                                                <i class="fa fa-globe fa-lg"></i>
                                                <span class="dt-side-nav__text"><?php //echo lang('web_control') 
                                                                                ?></span> </a>
                                        </li> -->
                                        <?php if ($companyInfo['kyc_status'] == 1) { ?>
                                            <li class="dt-side-nav__item" <?php if ($this->uri->segment(1) == "kyc-portal") {
                                                                                echo "selected";
                                                                            } ?>">
                                                <a href="<?= base_url('kyc-portal') ?>" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "kyc-portal") {
                                                                                                                        echo "active";
                                                                                                                    } ?>" title="KYC">
                                                    <i class="icon icon-forms-basic icon-fw icon-lg <?= $kycnotify == true ? 'dt-icon-alert' : '' ?>"></i>
                                                    <span class="dt-side-nav__text"><?= lang('kyc_portal') ?></span> </a>
                                            </li>
                                        <?php } ?>
                                        <?php if (
                                            $this->user_model->getPermissions('settings', 'email_templates', $userId) or
                                            ...
                                            <li class="dt-side-nav__item <?php if ($this->uri->segment(1) == "settings") {
                                                                                echo "selected open";
                                                                            } ?>">
                                                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
                                                    <i class="fa fa-toolbox fa-lg"></i><span class="dt-side-nav__text"><?php echo lang("settings") ?></span> </a>
                                                <!-- Sub-menu -->
                                                <ul class="dt-side-nav__sub-menu <?php echo $this->uri->segment(1) == "settings" ? "display-b" : "display-n" ?>">
                                                    <?php if ($this->user_model->getPermissions('settings', 'email_templates', $userId) or $role == ROLE_ADMIN) { ?>
                                                        <li class="dt-side-nav__item open <?php if ($this->uri->segment(1) == "settings" && $this->uri->segment(2) == "email_templates") {
                                                                                                echo "selected";
                                                                                            } ?>">
                                                            <a href="<?php echo base_url(); ?>settings/email_templates" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "settings" && $this->uri->segment(2) == "email_templates") {
                                                                                                                                                        echo "active";
                                                                                                                                                    } ?>" title="Traffic">
                                                    ...
                                                    <?php if ($this->user_model->getPermissions('settings', 'general_settings', $userId) or $role == ROLE_ADMIN) { ?>
                                                        <li class="dt-side-nav__item">
                                                            <a href="<?php echo base_url(); ?>settings" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "settings" && $this->uri->segment(2) == "") {
                                                                                                                                        echo "active";
                                                                                                                                    } ?>" title="Revenue">
                                                    ...
                                                    <?php if ($this->user_model->getPermissions('settings', 'payment_methods', $userId) or $role == ROLE_ADMIN) { ?>
                                                        <li class="dt-side-nav__item">
                                                            <a href="<?php echo base_url(); ?>settings/paymentMethods" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "settings" && $this->uri->segment(2) == "paymentMethods") {
                                                                                                                                                    echo "active";
                                                                                                                                                } ?>" title="Revenue">
                                                    ...
                                                    <?php if ($this->user_model->getPermissions('settings', 'languages', $userId) or $role == ROLE_ADMIN) { ?>
                                                        <li class="dt-side-nav__item">
                                                            <a href="<?php echo base_url(); ?>settings/languages" class="dt-side-nav__link <?php if ($this->uri->segment(1) == "settings" && $this->uri->segment(2) == "languages") {
                                                                                                                                                echo "active";
