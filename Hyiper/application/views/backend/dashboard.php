                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="dt-card">
                                        ...
                                        <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4 dt-card bg-secondary text-white">
                                            ...
                                            <!-- Media -->
                                            <div class="media">
                                                <i class="fa fa-users fa-3x fa-fw text-white mr-xl-5 mr-3 align-self-center"></i>
                                                <!-- Media Body -->
                                                <div class="flex-1">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <span class="h2 mb-0 font-weight-500 mr-2 text-white"><?php echo $allClients ?></span>
                                                        <span class="d-inline-flex text-white">
                                                            <i class="icon icon-profit icon-fw text-white"></i>+<?php echo $clientsthisweek ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="dt-card">
                                        ...
                                        <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4 dt-card bg-primary text-white">
                                            ...
                                            <!-- Media -->
                                            <div class="media">
                                                <i class="fa fa-dollar-sign fa-3x fa-fw text-white mr-xl-5 mr-3 align-self-center"></i>
                                                <!-- Media Body -->
                                                <div class="flex-1">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <span class="h2 mb-0 font-weight-500 mr-2 text-white"><?php echo $pendingWithdrawals > 0 ? to_currency($pendingWithdrawals) : to_currency('0.00') ?></span>
                                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="dt-card">
                                        ...
                                        <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4 dt-card bg-primary text-white">
                                            ...
                                            <div class="media">
                                                <i class="fa fa-gift fa-3x fa-fw text-white mr-xl-5 mr-3 align-self-center"></i>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="dt-card">
                                        ...
                                        <div class="dt-card__body p-xl-8 py-sm-8 py-6 px-4 dt-card bg-primary text-white">
                                            <span class="badge badge-secondary badge-top-right">Managers</span>

                                            <div class="media">
                                                <i class="fa fa-user-alt fa-3x fa-fw text-white mr-xl-5 mr-3 align-self-center"></i>

                                                <div class="flex-1">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <span class="h2 mb-0 font-weight-500 mr-2 text-white"><?php echo $allUsers ?></span>
                                                    </div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="w-100">
                                            <div class="dt-zone-stats__content">
                                                <i class="fa fa-wallet fa-2x text-white mr-xl-5 mr-3 align-self-center">
                                                </i>
                                                <div class="h1 display-4 font-weight-600 mb-1 text-white">
                                            ...
                                            <div class="pt-10p">
                                                <div class="row w-100">
                                                    <div class="col-6 text-center border-right">
                                                        <div class="h3 mb-1 font-weight-500 text-white">
                        ...
                        <?php if ($isVerified != 'Verified') { ?>
                            <div class="card bg-gradient-blue text-white">
                                ...
                                <div class="card-body p-6">
                                    ...
                                    <?php
                                    if ($isVerified == 'Verify Your Account') { ?>
                                        <a class="btn btn-default btn-sm text-dark" href="<?php echo base_url('verify') ?>"><?= lang('verify') ?></a>
                                    <?php } else if ($isVerified == 'Pending Resubmission') { ?>
                                        <a class="btn btn-default btn-sm text-dark" href="<?php echo base_url('verify') ?>"><?= lang('resubmit_documents') ?></a>
                                    <?php } ?>
                                </div>
                                <!-- /card body -->
                            </div>
                        ...
                        <?php if (empty($userInfo->pmtAccount) or $role == ROLE_ADMIN or $role == ROLE_MANAGER) { ?>
                            <div class="card bg-secondary text-white">
                                ...
                                <div class="card-body p-6">
                                    ...
                                    <a class="btn btn-default btn-sm text-dark" href="<?php echo base_url('profile') ?>"><?php echo lang("setup") ?></a>
                                </div>
                                <!-- /card body -->
                            </div>
                        <?php } ?>
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <h3 class="text-white mb-2"><?php echo lang("refer_earn") ?>
                                        ...
                                        <?php echo $intCount;
                                            ...
                                            echo $first . '%'; ?> <?php echo lang("from_your_referrals_deposit") ?><?php } ?></h3>

                                    <p><?php echo lang("referral_link") ?>: <?php echo base_url(); ?>signup/<?php echo $userInfo->refCode ?>
                                    </p>
                                    <form action="<?php echo base_url(); ?>invite" method="post" id="joinForm" name="joinForm">
                                        ...
                                        <button type="submit" id="invite" class="btn btn-info btn-block text-dark"><?php echo lang("invite_friends") ?></button>
                                        <?php echo form_close(); ?>
