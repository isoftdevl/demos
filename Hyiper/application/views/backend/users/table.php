                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr id="row<?php echo $record->userId ?>">
                                                            ...
                                                            <td>
                                                                <?php if ($isDemo == false) { ?>
                                                                    <?php echo $this->security->xss_clean($record->email) ?>
                                                                <?php } else { ?>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <?php if ($this->user_model->getPermissions('loginHistory', 'view', $userId) or $role == ROLE_ADMIN) { ?>
                                                                    <a class="btn btn-sm btn-primary trans-btn" href="<?= base_url() . 'login-history/' . $record->userId; ?>" title="Login history"><?php echo lang('login_history') ?></a> |
                                                                <?php } ?>
                                                                <?php if ($pageTitle == "Clients") { ?>
                                                                    <!-- Check the access for this component -->
                                                                    <?php if ($this->user_model->getPermissions('clients', 'view', $userId) or $role == ROLE_ADMIN) { ?>
                                                                        <a class="btn btn-sm btn-primary trans-btn" href="<?= base_url('referrals/' . $record->userId); ?>" title="Login history">Referrals</a> |
                                                                        <a class="btn btn-sm btn-info trans-btn" href="<?php echo base_url() . 'clients/viewClient/' . $record->userId; ?>" title="Edit"><?php echo lang('view') ?></a> |
                                                                    <?php } ?>
                                                                <?php } else if ($pageTitle == "Team") { ?>
                                                                    <!-- Check the access for this component -->
                                                                    <?php if ($this->user_model->getPermissions('teams', 'edit', $userId) or $role == ROLE_ADMIN) { ?>
                                                                        <a class="btn btn-sm btn-info trans-btn" href="<?php echo base_url('team/editManager/') . $record->userId; ?>" title="Edit"><?php echo lang('edit') ?></a> |
                                                                    <?php } ?>
                                                                <?php } ?>
                                                                <button class="btn btn-sm btn-info trans-btn confirmButton" data-url="<?php echo base_url('deleteUser') . '/' . $record->userId ?>" data-id="<?php echo $record->userId ?>" data-toggle="modal" data-target="#confirmationModal" title="Edit"><?php echo lang('delete') ?></button>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
