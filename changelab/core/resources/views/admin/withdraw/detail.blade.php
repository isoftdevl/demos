    ...
    <div class="row mb-none-30">
        ...
        <div class="col-lg-4 col-md-4 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Withdraw Via') {{optional($withdrawal->method)->name}}</h5>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('User Send Amount')
                            <span class="font-weight-bold">{{ $withdrawal->get_amount}} {{$withdrawal->get_currency}}</span>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Convertion Rate')
                            <span class="font-weight-bold"> 1 {{$withdrawal->send_currency}}
                                = {{ getAmount($withdrawal->rate ) }} {{$withdrawal->get_currency}}</span>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Amount')
                            <span
                                class="font-weight-bold">{{ getAmount($withdrawal->send_amount ) }} {{ trans($withdrawal->send_currency) }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Charge')
                            <span
                                class="font-weight-bold">{{ getAmount($withdrawal->charge ) }} {{ trans($withdrawal->send_currency) }}</span>
                        </li>
                        

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Payable
                            <span class="font-weight-bold">{{ getAmount($withdrawal->final_amount) }} {{$withdrawal->send_currency}}</span>
                        </li>
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="card-title mb-50 border-bottom pb-2">@lang('User Withdraw Information')</h5>
                        ...
                        @foreach($withdrawal->withdraw_information as $k => $val)
