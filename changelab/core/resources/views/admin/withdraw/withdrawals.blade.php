                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($withdrawals as $withdraw)
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Amount')" class="budget font-weight-bold">{{ getAmount($withdraw->get_amount) }} {{$withdraw->get_currency}}</td>
                                    <td data-label="@lang('Rate')" class="budget">{{ getAmount($withdraw->rate) }}  {{$withdraw->currency}}</td>
                                    <td data-label="@lang('Charge')" class="budget text-danger">{{ getAmount($withdraw->charge) }} {{$withdraw->send_currency}}</td>
                                    <td data-label="@lang('Payable')" class="budget font-weight-bold">{{ getAmount($withdraw->final_amount) }} {{ $withdraw->send_currency }} </td>
                                    @if(request()->routeIs('admin.withdraw.pending'))
