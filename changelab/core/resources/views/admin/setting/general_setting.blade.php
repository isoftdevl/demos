                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Site Location') </label>
                                    <input class="form-control  form-control-lg" type="text" name="location"
                                value="{{trans($general->location)}}">
                                </div>
                            </div>
                             <div class="col">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control  form-control-lg" type="text" name="email_from"
                                           value="{{trans($general->email_from)}}">
                                </div>
                            </div>
                             <div class="col">
                                <div class="form-group ">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Working Hour') </label>
                                    <input class="form-control  form-control-lg" type="text" name="working_hour"
                                           value="{{trans($general->working_hour)}}">
                                </div>
                            </div>
