                        ...
                        <div class="deposit-item">
                            <div class="deposit-thumb">
                                ...
                                <div class="thumb-content">
                                    <ul>
                                        <li>
                                            @lang('Limit :') {{ getAmount($data->min_amount) }} -
                                            {{ getAmount($data->max_amount) }} {{ $data->baseSymbol() }}
                                        </li>
                                        <li>
                                            @lang('Charge') - {{ getAmount($data->fixed_charge) }} +
                                            {{ getAmount($data->percent_charge) }}
                                        </li>
                                        <li>
                                            @lang('Processing Time') - 24 Hours
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="deposit-content">
                                ...
                                <a href="javascript:void(0)" data-id="{{ $data->id }}" data-resource="{{ $data }}"
                                    ...
                                    class=" btn  btn-success btn-block custom-success deposit theme-button"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('user.deposit.insert') }}" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn  custom-success deposit theme-button">@lang('Confirm')</button>
                    </div>
                </form>
            </div>
        </div>
