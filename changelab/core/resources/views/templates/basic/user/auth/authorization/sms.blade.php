                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header border-left-0 border-right-0 border-top-0">
                            ...
                            @lang('Please Verify Your Mobile to Get Access')</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('user.verify_sms')}}" method="POST" class="login-form">
                                ...
                                <div class="form-group mb-0">
                                    <p>@lang('Please check including your Junk/Spam Folder. if not found, you can ') <a href="{{route('user.send_verify_code')}}?type=phone" class="forget-pass"> @lang('Resend code')</a></p>
