    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card card-deposit primary-bg">
                    <div class="card-header">
                        <h5 class="card-title">@lang('Stripe Payment')</h5>
                    </div>
                    <div class="card-body card-body-deposit primary-bg">


                        <div class="card-wrapper"></div>
                        <br><br>

                        <form role="form" id="payment-form" method="{{ $data_get->method }}" action="{{ $data_get->url }}">
                            {{ csrf_field() }}
                            <input type="hidden" value="{{ $data_get->track }}" name="track">
                            <div class="row">
                                <div class="col-md-6">
