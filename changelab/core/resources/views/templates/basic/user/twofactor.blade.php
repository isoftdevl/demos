    ...
    <div class="container padding-top padding-bottom">
        <div class="row justify-content-center mt-4">
                ...
                @if(Auth::user()->ts)
                    <div class="card section-bg">
                        <div class="card-header">
                            <h5 class="card-title text-white m-0">@lang('Two Factor Authenticator')</h5>
                        </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="card section-bg">
                    <div class="card-header">
                        <h5 class="card-title text-white m-0">@lang('Google Authenticator')</h5>
                    </div>
                    <div class=" card-body section-bg">
                        ...
                        <a class="btn btn-success btn-md mt-3 bg__theme border-0" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en" target="_blank">@lang('DOWNLOAD APP')</a>
                    </div>
