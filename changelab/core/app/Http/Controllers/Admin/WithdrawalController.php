...
class WithdrawalController extends Controller
{
    ...
    public function details($id)
    {
        ...
        $page_title = $withdrawal->user->username . ' Withdraw Requested ' . getAmount($withdrawal->send_amount) . ' ' . $withdrawal->send_currency;

        return view('admin.withdraw.detail', compact('page_title', 'withdrawal'));
    }
