...
<body>
    ...
    <div class="installation-section padding-bottom padding-top">
        <div class="container">
            ...
            function sysInstall($env){
                $env['key'] = base64_encode(random_bytes(32));
                $env['url'] = getWebURL();
                $env_file = file_get_contents("env.txt");
                setDataValue(replaceData($env_file,$env),'../core/.env');
                return true;
            }
                                ...
                                <div class="success-area text-center">
                                    ...
                                    if ($_POST) {
                                        ...
                                        if (true) {
                                            ...
                                            echo "<h3 class='text-danger'>false<h3>";
                                        }
                                    }
                                    ?>
                                </div>
