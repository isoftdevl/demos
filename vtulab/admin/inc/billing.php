...
<?php 
	...
	if(!empty($airtelvtu) && !empty($mtnvtu) && !empty($glovtu) && !empty($etisalatvtu) && !empty($dstv) && !empty($gotv) && !empty($startimes) && !empty($airtelData) && !empty($mtnData) && !empty($gloData) && !empty($etisalatData) && !empty($ikeja) && !empty($eko) && !empty($kano) && !empty($jos) && !empty($phed) && !empty($ibedc) && !empty($waec) && !empty($smile) && !empty($sms) && !empty($abuja)) {	
