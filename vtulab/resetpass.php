                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title"><li class="fa fa-key"></li> Change Password </h2>
...
$updat = mysqli_query($conn,"UPDATE users SET pass='$newpwd' WHERE email ='$user' ") or die(mysqli_error()); 
...
Your account password on $serName has being changed <br> 
...
?> 
    ...
    <input id="inputText3" type="password" class="form-control" name="newpwd">
                                            </div>                   
                                         
                                     <div class="col-sm-6 pl-0">
                                         
                                                <p class="text-center">
                                                    <button type="submit" name="reset" class="btn btn-rounded btn-primary">Change Password</button>
