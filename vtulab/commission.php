									 ...
									 ?>
                                        ...
                                        <label for="inputText3" class="col-form-label">Please Select Reseller Package</label><br>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="carier"  class="custom-control-input" value="VIP" onclick="javascript:showTicket(); vip_value() " id="VIP" ><span class="custom-control-label">Upgrade + Setup My Reseller Portal  </span>
                                            </label>
                                            
                                            
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="carier" class="custom-control-input"value="Regular" onclick="javascript:showTicket(); regular_value()" id="Regular"><span class="custom-control-label" >Upgrade to Reseller </span>
                                            </label>
