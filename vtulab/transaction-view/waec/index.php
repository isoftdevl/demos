...
include('../../inc/waecpay.php');	

$qsel = "UPDATE transactions SET status='Completed',token='0',refer='N/A',channel='Wallet',amount='$amount',charge='$chargeAmt' WHERE ref='$tref' ";	
$sav = $conn->query($qsel);
...
$qrfel = "UPDATE transactions SET status='Failed',action='Reverse',del='Delete' WHERE ref='$requestId'";
			...
			echo'<div class="alert alert-info">
										...
										Serial:<strong>	'.$resp->description->Content.'</strong>, Products Name: <strong>'.$resp->description->product_name.'</strong>  
